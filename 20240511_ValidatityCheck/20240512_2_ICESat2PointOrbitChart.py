...
if __name__ == '__main__':
    ...
    i2019_temp_df = i2019_df[['Latitudes', 'Predict', 'H_SRTM', 'Row', 'Column']]
    i2020_temp_df = i2020_df[['Latitudes', 'Predict', 'H_SRTM', 'Row', 'Column']]
    i2022_temp_df = i2022_df[['Latitudes', 'Predict', 'H_SRTM', 'Row', 'Column']]
    ...
    plt.figure(dpi=300)
    plt.scatter(predict_df['Latitudes'], predict_df['Predict'], s=3, color='none', edgecolors="#DC143C", marker='^',
                label='Predict')
    plt.scatter(i2019_df['Latitudes'], i2019_df['H_SRTM'], s=1, marker='o', alpha=0.6, color='none',
                edgecolors="#ffcb74",
                label='ICESat-2 2019')
    plt.scatter(i2020_df['Latitudes'], i2020_df['H_SRTM'], s=1, marker='o', alpha=0.5, color='none',
                edgecolors="#0779e4",
                label='ICESat-2 2020')
    plt.scatter(i2022_df['Latitudes'], i2022_df['H_SRTM'], s=1, marker='o', alpha=0.4, color='none',
                edgecolors="#007944",
                label='ICESat-2 2022')
    # plt.title(_title)
