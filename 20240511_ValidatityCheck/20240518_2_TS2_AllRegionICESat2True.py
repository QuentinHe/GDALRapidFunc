# -*- coding: utf-8 -*-
# !/usr/bin/mgdal_env
# @Time : 2024/5/18 下午2:35
# @Author : Hexk
# @Descript : 计算全区域的所有ICESat2的点值
...
if __name__ == '__main__':
    ...
    point_path = r"E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_Supplement_20240516\19_PointFormal\20240518_AllRegionPoint\20240518_AllRegionPoint.shp"
    ...
    output_path = os.path.join(output_folder, '20240518_TS2_AllRegionICESat2TrueConstract.xlsx')
