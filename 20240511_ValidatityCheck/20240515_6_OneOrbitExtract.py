...
if __name__ == '__main__':
    raster_folder = r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Statistics_Data_20240511\Raster'
    ...
    plt.subplot(221)
    plt.plot(latitudes_list, delta_h_list, linewidth=1, alpha=0.6, c='#008B8B', label='ICESat-2')
    plt.plot(latitudes_list, predict_list, linewidth=0.8, linestyle='solid', c='#FBC02D', label='Predict')
    ax = plt.gca()
    ...
    plt.subplot(222)
    plt.plot(latitudes_list, delta_h_list, linewidth=1, alpha=0.6, c='#008B8B', label='ICESat-2')
    plt.plot(latitudes_list, b50_m5_list, linewidth=0.8, alpha=0.8, linestyle='solid', c='#FF8C00', label='M5')
    plt.plot(latitudes_list, b50_m10_list, linewidth=0.8, linestyle='solid', c='#DC143C', label='M10')
    ax = plt.gca()
    ax.axes.xaxis.set_ticklabels([])    # 只显示刻度线

    plt.subplot(223)
    plt.plot(latitudes_list, delta_h_list, linewidth=1, alpha=0.6, c='#008B8B', label='ICESat-2')
    plt.plot(latitudes_list, b50_p5_list, linewidth=0.8, linestyle='solid', c='#7B1FA2', label='P5')
    plt.plot(latitudes_list, b50_p10_list, linewidth=0.8, linestyle='solid', c='#0097A7', label='P10')

    plt.subplot(224)
    plt.plot(latitudes_list, delta_h_list, linewidth=1, alpha=0.6, c='#008B8B', label='ICESat-2')
    plt.plot(latitudes_list, b50_r5_list, linewidth=0.8, linestyle='solid', c='#388E3C', label='R5')
    plt.plot(latitudes_list, b50_r10_list, linewidth=0.8, linestyle='solid', c='#FBC02D', label='R10')
