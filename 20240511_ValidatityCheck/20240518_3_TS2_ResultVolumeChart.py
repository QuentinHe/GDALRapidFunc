...
if __name__ == '__main__':
    excel_path = r"E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Statistics_Data_20240511\Image\TS2_Result.xlsx"
    chart1_df = pd.read_excel(excel_path, sheet_name='AllRegion')
    ...
    chart2_df = pd.read_excel(excel_path, sheet_name='ClipRegion')
    # plt.rcParams['ytick.direction'] = 'in'  # 将x的刻度线方向设置向内
    ...
    plt.subplot(312)
    chart4_df_1 = pd.read_excel(excel_path, sheet_name='ICESat2AllRegionPredict')
    chart4_df_2 = pd.read_excel(excel_path, sheet_name='ICESat2AllRegionTrue')
    ...
    plt.subplot(313)
    chart3_df_1 = pd.read_excel(excel_path, sheet_name='ICESat2ClipPredict')
    chart3_df_2 = pd.read_excel(excel_path, sheet_name='ICESat2ClipTrue')
    ...
    plt.tight_layout()
    plt.savefig(
        r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Statistics_Data_20240511\Image\20240517_3_TS2_BarChart.jpeg')
    plt.show()
