...
if __name__ == '__main__':
    csv_path = r"E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_Pre_20240510\20240511_2_ProfilePointCSV\20240511_1_ProfilePoint.csv"
    ...
    plt.plot(latitudes_list, srtm_dem_list, linewidth=1, alpha=0.8, linestyle='solid', c='#FF8C00', label='SRTM DEM')
    plt.plot(latitudes_list, predict_dem_list, linewidth=0.8, linestyle='-.', c='#DC143C', label='Predict DEM')
