...
if __name__ == '__main__':
    # 计算全区域分级
    raster_folder = r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_Supplement_20240516\17_ClipResult'
    reclassify_path = r"E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_Supplement_20240516\18_OutputExcel\20240517_TS2_ClipRegionReclassify.tif"
    ...
    output_path = os.path.join(output_folder, '20240517_2_TS2_ClipRegion.xlsx')
