...
plt.figure(dpi=300)
width = 0.4
p1 = plt.bar(months_labels, year_2019_num, width, label='2019', color='#22668d', ec='grey', lw=0.2)
p2 = plt.bar(months_labels, year_2020_num, width, bottom=year_2019_num, label='2020', color='#8ecddd',
             ec='grey',
             lw=0.2)
p3 = plt.bar(months_labels, year_2021_num, width, bottom=(year_2020_num + year_2019_num), label='2021',
...
plt.yticks([i * 5000 for i in range(1, 7)], labels=[f'{i * 5}k' for i in range(1, 7)], fontsize=18)
plt.xlabel('Month', fontsize=22)
plt.ylabel('Numbers of ICESat2 Footprints', fontsize=22)
plt.legend(frameon=False,prop={'size': 14}, loc=(0.01, 1.01), ncol=4)
plt.tight_layout()
# 绘制折线图
...
plt.tight_layout()
plt.savefig(
    r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_Final_20231018\1_Cartography\2_Method&Data\20231026_1_ICESat2PointCount.jpeg')
plt.show()
