...
year_2019_num = df.iloc[0, 1:].values
year_2020_num = df.iloc[1, 1:].values
year_2021_num = df.iloc[2, 1:].values
year_2022_num = df.iloc[3, 1:].values
...
plt.ylabel('Numbers of ICESat2 Footprints', fontsize=12)
...
plt.savefig(r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_Final_20231018\1_Cartography\2_Method&Data\20231026_1_ICESat2PointCount.png')
plt.show()
