...
if __name__ == '__main__':
    ...
    y = [-4.75972427, -4.874527576, -4.730456218, -4.840110744, -4.772188928, -4.334969482, -3.789788121, -3.589013375,
         -3.900730804, -4.401600098, -4.555493354, -4.825066729
         ]
    ...
    pl.plot(t, y, marker='+', label=u"Original Observations")
    # pl.plot(month, fitting_y_list, marker='^', label=u"Origin Observations")
    pl.plot(t, func1(t, plsq[0]), label=u"Fitting observations")
    pl.legend()
    pl.show()
    for i in t:
