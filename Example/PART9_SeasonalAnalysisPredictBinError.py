...
if __name__ == '__main__':
    ...
    nasa_point_folder = r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_20231009\1_BasePoint_Merge'
    # srtm_point_folder = r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_20231004\0_BaseData\BasePoint\SRTM'
    srtm_point_folder = r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_20231009\1_BasePoint_Merge'
    ...
    output_error_csv_folder = r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_20231009\3_CSVData\1_ErrorCSV'
    output_mask_folder = r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_20231009\2_PredictData\3_MaskData'
    output_change_csv_folder = os.path.join(
        r'E:\Glacier_DEM_Register\Tanggula_FourYear_Data\Test_20231009\3_CSVData\2_ChangeCSV')
            ...
            for bin_index, bin_item in enumerate(bin_list):
                for season_index, season_item in enumerate(season_list):
                    ...
                    if dem_item == 'NASA':
                        ...
                        for point_files_index, point_files_item in enumerate(nasa_point_files_list):
                            if dem_item in point_files_item and str(
                                    year_item) in point_files_item and f'Bin_{bin_item}' in point_files_item and f'Season{season_item}' in point_files_item:
                                print(f'当前执行条件为:{dem_item} {year_item} {bin_item} Season{season_item}'
                        ...
                        for merge_predict_index, merge_predict_item in enumerate(merge_predict_files_list):
                            if dem_item in merge_predict_item and str(
                                    year_item) in merge_predict_item and f'_{bin_item}' in merge_predict_item and f'Season{season_item}' in merge_predict_item:
                    ...
                    csv_output_path = os.path.join(output_error_csv_folder,
                                                   f'ErrorAnalysis_{dem_item}_{year_item}_Bin_{bin_item}_Season{season_item}')
                    ...
                    output_mask_path = os.path.join(output_mask_folder,
                                                    f'Mask_{dem_item}_{year_item}_Bin_{bin_item}_Season{season_item}')
