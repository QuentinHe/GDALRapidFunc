...
if __name__ == '__main__':
    ...
    # dem_productions_path_list, dem_productions_name_list = [], []
    # for index, item in enumerate(raster_name_list):
    #     if 'SRTM' in item:
    #         dem_productions_name_list.append(item)
    #         dem_productions_path_list.append(raster_path_list[index])
    ...
    # other_raster_path_tuple = tuple(dem_productions_path_list[0:])
    # print(dem_productions_name_list)
    # print(other_raster_path_tuple)
    # RasterDivide(dem_productions_path_list[0], output_folder, 19, *other_raster_path_tuple)
